...
#### 2. GameGen-X: Interactive Open-world Game Video Generation
...
#### 3. Motion Control for Enhanced Complex Action Video Generation
...
#### 5. Mogo: RQ Hierarchical Causal Transformer for High-Quality 3D Human Motion Generation
Dongjie Fu (Mogo AI)
<details span>
<summary><b>Abstract</b></summary>
...
#### 6. STIV: Scalable Text and Image Conditioned Video Generation
...
#### 7. Video Storyboarding: Multi-Shot Character Consistency for Text-to-Video Generation
