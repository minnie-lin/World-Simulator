...
#### 3. GameGen-X: Interactive Open-world Game Video Generation
...
#### 4. Motion Control for Enhanced Complex Action Video Generation
...
#### 5. AnimateAnything: Consistent and Controllable Animation for video generation
...
#### 6. FlipSketch: Flipping Static Drawings to Text-Guided Sketch Animations (Text-to-Video Finetuning)
...
#### 7. DreamRunner: Fine-Grained Storytelling Video Generation with Retrieval-Augmented Motion Adaptation
...
#### 8. Mogo: RQ Hierarchical Causal Transformer for High-Quality 3D Human Motion Generation
Dongjie Fu (Mogo AI)
<details span>
<summary><b>Abstract</b></summary>
...
#### 10. STIV: Scalable Text and Image Conditioned Video Generation
...
#### 11. Video Storyboarding: Multi-Shot Character Consistency for Text-to-Video Generation
